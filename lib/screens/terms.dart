  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Container(
          margin: const EdgeInsets.only(left: 40, bottom: 5, right: 40),
...
The Service may include advertisements, which may be targeted to the Content or information on the Service, or other information. The types and extent of advertising by Duolingo on the Service are subject to change. In consideration for Duolingo granting you access to and use of the Service, you agree that Duolingo and its third party providers and partners may place such advertising in connection with the display of content or information submitted by you or others.""";
  ...
  String promotion =
      """Duolingo Promotion Codes (each a “Promotional Code”) are made available by Duolingo (either directly or through a partner) subject to the Terms and Conditions of Service (“Terms and Conditions”). Each Promotional Code is made available in connection with a form of an auto-renewing periodic subscription (as defined in the Terms and Conditions).

The Promotional Code.
Each Promotional Code provides access to Duolingo Plus: A. at the price advertised; and B. beginning the moment that you confirm your acceptance of the Promotional Code by submitting valid payment details that are accepted by Duolingo (the “Promotional Period”); and C. in some circumstances, subject to an overall limit of allowed redemptions of that Promotional Code. By submitting your payment details, you (i) confirm your acceptance of the Promotional Code advertised; (ii) accept and agree to these Promotional Code Terms; and (iii) acknowledge and agree to the Terms and Conditions.

Eligibility.
In order to be eligible for a Promotional Code, users must satisfy all of the following conditions (each an “Eligible User”): A. Unless you are subscribing to a Promotional Code that is advertised as available to current subscribers, you must not be a current subscriber. B. Provide Duolingo with a valid and current payment method that is approved by Duolingo. C. Additional eligibility requirements (if any) as advertised from time-to-time in connection with a Promotional Code. Eligible Users may accept a Promotional Code once - previous users may not redeem the offer again.

Availability.
A Promotional Code must be accepted before the applicable expiration date advertised, if any. Except where prohibited by law, Duolingo reserves the right to modify, suspend or terminate a Promotional Code at any time and for any reason, in which case we will not honour subsequent Promotional Code enrollments.

Duration and cancellation.
Unless you cancel your subscription before the end of the Promotional Period, you will automatically become a recurring subscriber and your Duolingo Plus subscription will continue to automatically renew for additional periods equal to the expiring subscription term, unless you cancel before the end of the relevant subscription term pursuant to Duolingo’s terms and conditions. The payment method you provided will automatically be charged for the then-current subscription price. If you cancel during the Promotional Period, you will lose access to Duolingo Plus and you understand and agree that you will receive no refund or exchange of any kind, including for any unused virtual currency or other Virtual Item, any Content or data associated with your use of the Service, or for anything else.""";
  String copyright =
